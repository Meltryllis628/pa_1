                ...
                while True:
                    match convert_bytes_to_int(read_bytes(client_socket, 8)):
                        ...
                        case 1:
                            ...
                            file_data = sym_key.decrypt(encrypted_data)
                        ...
                        case 3:
                            ...
                            # print(certification)
                        case 4:
                            sym_key_len = convert_bytes_to_int(read_bytes(client_socket, 8)) 
                            enc_sym_key_byte = read_bytes(client_socket, sym_key_len)
                            sym_key_byte = decrypt(enc_sym_key_byte,pri)
                            sym_key = Fernet(sym_key_byte)
